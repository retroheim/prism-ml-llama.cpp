...
extern "C" {
    ...
    enum llama_ftype {
        ...
        LLAMA_FTYPE_MOSTLY_Q1_0_g128     = 40, // except 1d tensors (= PrismML / TheTom Q1_0 file_type on disk)
        LLAMA_FTYPE_MOSTLY_Q2_0          = 41, // except 1d tensors — DO NOT MOVE (GGUF ABI)
        LLAMA_FTYPE_MOSTLY_Q1_0          = 42, // except 1d tensors (local 32-block)
        LLAMA_FTYPE_MOSTLY_TQ3_1S        = 43, // except 1d tensors (TheTom)
        LLAMA_FTYPE_MOSTLY_TQ4_1S        = 44, // except 1d tensors (TheTom)
