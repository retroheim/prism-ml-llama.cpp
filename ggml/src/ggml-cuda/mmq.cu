...
static void ggml_cuda_mul_mat_q_switch_type(ggml_backend_cuda_context & ctx, const mmq_args & args, cudaStream_t stream) {
    switch (args.type_x) {
        ...
        case GGML_TYPE_Q1_0_g128:
            ...
            break;
        // Q2_0 has no mmq_type_traits specialization yet — falls through to cuBLAS via should_use_mmq returning false
        case GGML_TYPE_Q4_0:
...
bool ggml_cuda_should_use_mmq(enum ggml_type type, int cc, int64_t ne11, int64_t n_experts) {
    ...
    switch (type) {
        ...
        // Q2_0 has no mmq_type_traits specialization — uses cuBLAS fallback
        case GGML_TYPE_Q1_0:
        case GGML_TYPE_Q1_0_g128:
        case GGML_TYPE_Q4_0:
        case GGML_TYPE_Q4_1:
